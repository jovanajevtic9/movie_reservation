    ...
    <div class="col-md-8 " >
       <div class="row ">
          <ul class="nav nav-tabs ">
            <li role="presentation" class="active"><a href="index.php">Pocetna</a></li>
         ...
         <div class="col-md-8 ">
                    ...
                    <div class="carousel-inner" role="listbox">
                      <div class="item active" >
                        <img src="img/img1.jpg" alt="..." class="img-responsive img-thumbnail" >
                        <div class="carousel-caption">
                          Movie Night
                        </div>
                      </div>
                      <div class="item">
                        <img src="img/img2.jpg" alt="..." class="img-responsive img-thumbnail">
                        <div class="carousel-caption">
                          Movie 6
                        </div>
                      </div>
                      <div class="item" >
                        <img src="img/img3.jpg" alt="..."  class="img-responsive img-thumbnail">
                        <div class="carousel-caption">
                          Movie 3
                        </div>
                      </div>
