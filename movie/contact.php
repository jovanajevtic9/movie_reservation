...
<script>
var myCenter=new google.maps.LatLng(44.786568,20.448922);
var ma = new google.maps.LatLng(45.267135,19.833550);

function initialize()
{
var mapProp = {
  center:new google.maps.LatLng(44.786568,20.448922),
  zoom:13,
                                    ...
                                    <div id="googleMap" style="width:100%;height:300px;"></div><br>
                                     <div id="kontakt">
                                      <form method="post" action="controller.php">
                                        <input type="hidden" name="podaci" value="poruka" > 
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="poruka" placeholder="Poruka" name="poruka" required></textarea>
                                          </div>
